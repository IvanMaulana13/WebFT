...
export interface SharedSidebarProps {
  headerTitle: string; // Mobile top label, e.g. "PENELITIAN & PENGABDIAN"
  sidebarHeader1: string; // Desktop line 1, e.g. "PENELITIAN &"
  sidebarHeader2: string; // Desktop line 2, e.g. "PENGABDIAN"
  ariaLabel: string;
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-[10px] font-bold tracking-wider text-slate-400 uppercase leading-tight truncate">
                {headerTitle}
              </span>
